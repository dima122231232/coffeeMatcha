            ...
            <div className="about-page__layout">
                <nav className="about-page__nav" aria-label="About navigation">
                    <ul className="about-page__nav-list StartAnimation">
                        <li><GateLink href="/careers" onClick={close}><span>Careers</span></GateLink></li>
                        <li><GateLink href="/privacy" onClick={close}><span>Privacy</span></GateLink></li>
                        <li><GateLink href="/terms" onClick={close}><span>Terms of Service</span></GateLink></li>
                        <li><GateLink href="https://instagram.com" target="_blank" rel="noopener noreferrer" onClick={close}><span>Instagram</span></GateLink></li>
                        <li><GateLink href="https://tiktok.com" target="_blank" rel="noopener noreferrer" onClick={close}><span>TikTok</span></GateLink></li>
                    </ul>
                </nav>
