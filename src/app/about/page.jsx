            ...
            <div className="about-page__layout">
                <nav className="about-page__nav" aria-label="About navigation">
                    <ul className="about-page__nav-list StartAnimation">
                        <li><GateLink href="/careers"><span>Careers</span></GateLink></li>
                        <li><GateLink href="/privacy"><span>Privacy</span></GateLink></li>
                        <li><GateLink href="/terms" ><span>Terms of Service</span></GateLink></li>
                        <li><GateLink href="https://instagram.com" target="_blank" rel="noopener noreferrer"><span>Instagram</span></GateLink></li>
                        <li><GateLink href="https://tiktok.com" target="_blank" rel="noopener noreferrer"><span>TikTok</span></GateLink></li>
                    </ul>
                </nav>
